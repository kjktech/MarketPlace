...
Route::group(['middleware' => ['auth', 'isVerified'], 'prefix' => 'account', 'as' => 'account.', 'namespace' => 'Account'], function()
{
  ...
  Route::get('/wishlist', 'ProfileController@wishlist')->name('view.wishlist');
...
Route::post('shopwholesale', 'CartController@postwholesale')->name('post.wholesale');
...
Route::group(['prefix' => 'listing'], function()
  {
    ...
    Route::get('/{listing}/{slug}/whsale', 'ListingController@wholesale')->name('wholesale');
  ...
  Route::post('/productgetpayid', 'PaymentController@productgetpayid')->name('product.getpayid');
  ...
  Route::get('/order/contact', 'CheckoutbController@getordercontact')->name('getorder.contact');

  Route::post('/order/contact', 'CheckoutbController@postordercontact')->name('postorder.contact');

  Route::post('/order/pickcontact', 'CheckoutbController@postpickordercontact')->name('postorder.pickcontact');

  Route::get('/wholesale-checkout', 'CheckoutbController@wholesale')->name('checkout.wholesale');
  ...
  Route::get('/getcities', 'Account\ProfileController@getcities')->name('ajax.getcities');
...
// Search listings/producs
Route::get('/productsearch', 'ScanController@searchproducts')->name('listings.search');
...
Route::group(['middleware' => ['auth']], function () {
  ...
  Route::resource('create', 'CreateController');
    ...
    Route::get('/{shopping}/transaction', 'TransactionController@transaction')->name('transaction');
