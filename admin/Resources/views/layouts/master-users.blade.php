...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <div id="wrapper" class="toggled">
        ...
        <li class="{{ active(['panel.business.dashboard']) }}">
        ...
        @role('super-admin')
        <li class="{{ active(['panel.users.index']) }}">
            <a href="{{ route('panel.users.index') }}">
              <svg class="icon icon-users-group">
                <use xlink:href="#icon-users-group"></use>
              </svg> All Users </a>
        </li>
        <li class="{{ active(['panel.users.adminindex']) }}">
            <a href="{{ route('panel.users.adminindex') }}">
              <svg class="icon icon-users-group">
                <use xlink:href="#icon-users-group"></use>
              </svg> Admin Users </a>
        </li>
        @endrole
        <li class="{{ active(['panel.newsletter.user']) }}">
            <a href="{{ route('panel.newsletter.user') }}">
              <svg class="icon icon-users-group">
                <use xlink:href="#icon-users-group"></use>
              </svg> Newsletter Users </a>
        </li>
