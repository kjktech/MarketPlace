...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <div id="wrapper" class="toggled">
        ...
        <li class="active">
          <a href="{{ route('panel.business.dashboard') }}">
            <svg class="icon icon-directory-big">
              <use xlink:href="#icon-directory-big"></use>
            </svg> Business Directory </a>
        </li>
        <li class="{{ active(['*directorycategories*']) }}">
            <a href="{{ route('panel.directorycategories.index') }}">
              <svg class="icon icon-blog-category">
                <use xlink:href="#icon-blog-category"></use>
              </svg> Business Categories </a>
        </li>
        <li class="{{ active(['panel.directories.create']) }}">
            <a href="{{ route('panel.directories.create') }}?topbrand=topbrand">
              <svg class="icon icon-pencil-edit-white">
              <use xlink:href="#icon-pencil-edit-white"></use>
            </svg> Create Top Brand </a>
        </li>
        <li class="{{ active(['panel.directories.create']) }}">
            <a href="{{ route('panel.directories.create') }}">
              <svg class="icon icon-pencil-edit-white">
              <use xlink:href="#icon-pencil-edit-white"></use>
            </svg> Create Business </a>
        </li>
        <li class="{{ active(['panel.topbrands*']) }}">
            <a href="{{ route('panel.topbrands') }}">
              <svg class="icon icon-top-star">
                <use xlink:href="#icon-top-star"></use>
              </svg> Manage Top Brands </a>
        </li>
        <li class="{{ active(['panel.directories.index']) }}">
            <a href="{{ route('panel.directories.index') }}">
              <svg class="icon icon-line-chart">
                <use xlink:href="#icon-line-chart"></use>
             </svg> Manage Businesses </a>
        </li>
        <li class="{{ active(['panel.payment.directory']) }}">
            <a href="{{ route('panel.payment.directory') }}">
              <svg class="icon icon-subscription">
                <use xlink:href="#icon-subscription"></use>
              </svg> Subscriptions </a>
        </li>
        <li class="{{ active(['panel.loyalties*']) }}">
            <a href="{{ route('panel.loyalties.index') }}">
              <svg class="icon icon-loyalty">
                  <use xlink:href="#icon-loyalty"></use>
              </svg> Loyalties </a>
        </li>
