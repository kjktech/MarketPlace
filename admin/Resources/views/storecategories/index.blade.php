...
@section('content')
    ...
    <h2>Categories <a href="{{ route('panel.storecategories.create')}}" class="btn btn-link btn-xs"><i class="mdi mdi-plus"></i> Add new</a></h2>
                   ...
                   <tbody>
                       ...
                       <tr>
                           ...
                           <td>
                               ...
                               <a href="{{ route('panel.storecategories.edit', $category['id']) }}" class=" text-muted float-right"><i class="fa fa-pencil"></i></a>
                           </td>
                       </tr>
                       @endforeach
                   </tbody>
