...
@section('content')
<div class="container">
    <a href="{{ route('panel.directorycategories.index') }}" class="mb-1"><i class="fa fa-angle-left" aria-hidden="true"></i> back</a>
        ...
        <div class="col-sm-12">
          ...
          <div class="panel panel-default">
              <div class="panel-body">
                  ...
                  <br>
                  <label for="Category Image" class="control-label">Category page banner (1439 X 195)</label>
                  @if($form->getModel()->pagebanner)
                       <br>
                      <img width=300 src="{{ $form->getModel()->pagebanner }}?time={{time()}}" />
                  @endif
                  <div class="form-group">
                         <input name="pagebannerimage" type="file">
                  </div>
                  <br>
                  <label for="Category Icon" class="control-label">Category icon (32 X 28)</label>
