                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                {{ Form::checkbox('is_active', true, null, ['class' => 'form-check-input', 'id' => 'is_active']) }}
                                <label class="form-check-label" for="is_active">Is active</label>
                                <a href="" class="small text-muted" data-toggle="tooltip" data-placement="top" title="Is active."><i class="fa fa-info-circle"></i></a>
                            </div>
