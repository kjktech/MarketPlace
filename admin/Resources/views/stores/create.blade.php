...
@section('content')
    ...
    <div class="col-sm-9 pl-sm-5">
      ...
      <div class="row">
        <div class="col-6">
            <h5 class="text-dark">{{ __("Create Store") }}</h5>
        </div>

      </div>
      {!! Form::model(null, ['route' => ['panel.stores.store'], 'class' => 'formsy form create-form', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
      <a id="details_section"></a>
      @include('panel::stores.partials.create_initial')
      <div class="card mb-4">
