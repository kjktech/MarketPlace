...
@section('content')
    ...
    <h2>Top Brands<a href="{{ route('panel.directories.create')}}?topbrand=topbrand" class="btn btn-link btn-xs"><i class="mdi mdi-plus"></i> Add new</a></h2>
    <br />
  ...
  <tbody>
      ...
      <tr>
        ...
        <td>
            ...
            <a href="{{ route('panel.topledger.index', $item) }}" class="text-muted float-right edit-icon-space"><i class="fa fa-address-book"></i></a>
