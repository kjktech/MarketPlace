...
<body class="email-module">
    ...
    <header>
       ...
       <div style="height: 550px;" class="container verifymsg">
         <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading"><h1>Site Under Maintenance</h1></div>
                <br>
                <div class="panel-body">
                    <span class="help-block">
                        <strong><h3>Sorry, we are doing some maintenance. Please check back soon.</h3></strong>
                    </span>
                    <br>
                    <!--
                    <div class="">
