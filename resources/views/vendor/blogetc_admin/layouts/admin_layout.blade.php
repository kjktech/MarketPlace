...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item">
        <a class="nav-link" target="_blank" href="{{ url('/panel') }}">Afiaanyi Admin Dashboard <i class="fa fa-tags" aria-hidden="true"></i></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" target="_blank" href="{{ route('panel.store.dashboard') }}">Marketplace dashboard <i class="fa fa-tags" aria-hidden="true"></i></a>
      </li>
      <li class="nav-item">
    ...
    <div id="wrapper" class="toggled">
        ...
        <li class="{{ active(['panel.blog.posts']) }}">
            <a href="{{ route('panel.blog.posts') }}">
              <svg class="icon icon-admin-blogging">
                <use xlink:href="#icon-admin-blogging"></use>
              </svg>
              Blog Posts </a>
        </li>
        <li class="{{ active(['blogetc.admin.comments.index']) }}">
            <a href="{{ route('blogetc.admin.comments.index') }}">
              <svg class="icon icon-blog-comment">
                <use xlink:href="#icon-blog-comment"></use>
              </svg>
               Comments </a>
        </li>
        <li class="{{ active(['blogetc.admin.categories.index']) }}">
        ...
        <li class="{{ active(['blogetc.admin.images.all']) }}">
            <a href="{{ route('blogetc.admin.images.all') }}">
              <svg class="icon icon-admin-blog-image">
                  <use xlink:href="#icon-admin-blog-image"></use>
              </svg>
               Images </a>
        </li>
        @else
