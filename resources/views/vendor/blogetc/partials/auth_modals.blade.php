            ...
            <div class="modal-body signup">
                ...
                <div class="signup__form">
                    <form action="" id="modal-login-form">
                        {{ csrf_field() }}
                        <input required type="email" name="email" class="signup__form-input form-control" placeholder="Email">
                        <input required type="password" name="password" class="signup__form-input form-control" placeholder="Password">
