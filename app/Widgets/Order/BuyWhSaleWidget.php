...
class BuyWhSaleWidget extends AbstractWidget
{
    /**
     ...
     */
    public function run($listing, $avail_quantity, $selected_quantity)
    {
        //
		$total = 0;
        ...
        return view('listing.widgets.buy_widget_latest_whsale', [
            'config' 	    => $this->config,
            'listing' 	    => $listing,
            'quantity_max' 	    => $avail_quantity,
